#!/usr/bin/env python3
"""
Label FINAL filtered positions with Stockfish.

These positions have:
- 18-22 pieces (middlegame)
- Both kings on back ranks (no exposed king tactics)
"""
...
INPUT_FILE = "data/self_play/positions_final.fen"
...
def main():
    ...
    print("=" * 70)
    print("STOCKFISH LABELING - FINAL FILTERED POSITIONS")
    print("=" * 70)
    ...
    if not input_path.exists():
        ...
        print("Run filter_safe_kings.py first!")
        return
    ...
    print("If you see >5 failures in first 100, something is still wrong.")
    print()
    ...
    with open(output_path, 'w') as out:
        for i, fen in enumerate(positions, 1):
            ...
            if i % 100 == 0:
                ...
                print(f"  Labeled: {labeled:,} | Failed: {failed:,} | Fail rate: {100*failed/i:.1f}%")
