#!/usr/bin/env python3
"""
Label low-risk chess positions with Stockfish evaluations.

INPUT:  data/self_play/positions_low_risk.fen (filtered for low risk)
...
INPUT_FILE = "data/self_play/positions_low_risk.fen"
...
def main():
    ...
    print("=" * 70)
    print("STOCKFISH LABELING - LOW RISK POSITIONS")
    print("=" * 70)
    ...
    if not input_path.exists():
        ...
        print("Run filter_high_risk.py first!")
        return
    
    # Read positions
    print("Reading low-risk positions...")
