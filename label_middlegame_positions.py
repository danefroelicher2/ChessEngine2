#!/usr/bin/env python3
"""
Label middlegame chess positions with Stockfish evaluations.

INPUT:  data/self_play/positions_middlegame.fen (18-22 pieces only)
OUTPUT: data/self_play/positions_labeled.jsonl
"""
...
def main():
    ...
    print("=" * 70)
    print("STOCKFISH LABELING - MIDDLEGAME POSITIONS")
    print("=" * 70)
    ...
    if not input_path.exists():
        ...
        print("Run filter_middlegame.py first!")
        return
